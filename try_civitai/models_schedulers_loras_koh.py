...
# python convert_original_stable_diffusion_to_diffusers.py --checkpoint_path ai_files/realdosmix_.safetensors --from_safetensors --dump_path ai_directory/realdosmix
"""
import itertools
import math
import os.path

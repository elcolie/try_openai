...
prompts = [
    # "Replace her cloth with sexy bikini",
    # "Replace her cloth with see through shirt",
    # "Replace her cloth with micro bikini",
    # "Replace her cloth with stripe bikini",
    "She is naked and small breast",
    "She is naked, tatoo on body, and small breast",
    "She is naked, rope bondage, and small breast",
]
...
negative_prompt: str = "blur, bad quality, bad shape, skinny, cloths"
source_image = load_image("/Users/sarit/Documents/bell/a.jpg")
masked_image = load_image("/Users/sarit/Documents/bell/a_mask.png")
out_dir: str = "bell_inpaint"
